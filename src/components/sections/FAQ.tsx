    ...
    <section id="faq" className="relative py-16 lg:py-24 bg-zinc-50 overflow-hidden">
      ...
      <div className="container mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <Accordion type="single" collapsible className="space-y-3">
            {filtered.map((faq, i) => (
              ...
              >
                ...
                <AccordionContent className="text-sm text-zinc-600 leading-relaxed pb-5 pl-10 pr-2">
                  {faq.answer}
                </AccordionContent>
              </AccordionItem>
            ))}
        ...
        <motion.div
          ...
          className="mt-8 p-5 rounded-2xl bg-gradient-to-r from-pink-50 to-orange-50 border border-pink-100 text-center"
        >
