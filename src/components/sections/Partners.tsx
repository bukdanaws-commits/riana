...
export function Partners() {
  return (
    <section id="partner" className="relative py-16 lg:py-24 bg-white overflow-hidden">
      ...
      <div className="absolute -top-32 right-0 h-96 w-96 rounded-full bg-violet-200/40 blur-3xl -z-10" />
      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-violet-100 border border-violet-200 mb-4">
            <Handshake className="h-3.5 w-3.5 text-violet-600" />
            <span className="text-xs font-bold text-violet-800 tracking-wide uppercase">Partnership Opportunity</span>
          </div>
        ...
        <motion.div
          ...
          transition={{ duration: 0.5 }}
          className="rounded-3xl bg-gradient-to-br from-zinc-900 via-violet-900 to-fuchsia-900 p-6 lg:p-10 text-white overflow-hidden relative"
        >
          ...
          <div className="relative">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {PARTNER_TIERS.map((tier, i) => (
                ...
                >
                  {i === 0 && (
                    <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-0.5 rounded-full bg-amber-400 text-amber-950 text-[10px] font-bold tracking-wider uppercase">
                      Most Popular
                    </div>
                  )}
