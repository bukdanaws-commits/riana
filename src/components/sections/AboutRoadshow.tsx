      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-violet-100 border border-violet-200 mb-4">
            ...
            <span className="text-xs font-bold text-violet-800 tracking-wide uppercase">The Big Picture</span>
          </div>
...
function Pillar({
  ...
  return (
    <motion.div
      ...
      className="group relative p-7 rounded-3xl bg-white border-2 border-zinc-100 hover:border-pink-200 hover:shadow-xl transition-all overflow-hidden"
    >
